...
public class Products {
    ...
    public Products(int productPhoto, String productName, double productPrice, double soldQty, String productDesc, double productRate) {
