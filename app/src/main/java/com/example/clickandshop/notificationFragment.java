...
public class notificationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Notification to Highlight fragment navigation
        View notification1 = v.findViewById(R.id.notification1);
        View notification2 = v.findViewById(R.id.notification2);
        View notification3 = v.findViewById(R.id.notification3);
